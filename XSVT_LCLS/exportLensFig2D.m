...
imagesc(n1,m1,phi1.*mask1.*kw2,[a-3*b a+3*b]+eps)
hold on
...
% xlabel('mm');ylabel('nm')
% yyaxis right
plot(n1,phi1(mil(1),:).*kw2.*mask1(mil(1),:),'b-','LineWidth',2)
xlabel('mm');ylabel('rad')
...
% xlabel('mm');ylabel('nm')
% yyaxis right
plot(n1,phi1(:,mil(2)).*kw2.*mask1(:,mil(2)),'black','LineWidth',2)
xlabel('mm');ylabel('rad')
%legend()
hold off
