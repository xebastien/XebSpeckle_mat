...
% ====================================================================================
szspot = 30;
winvect = 4; % width of the vector in 2D *2+1

winsize = 9; % who far to probe and look for the correlation peak

ROI1 = [400 1550 580 1700];% for 1 trip one lens
[X,Y] = meshgrid(1:1:n1,1:1:m1);
file1 = sum(stsample(ROI1(1)+winsize+2:ROI1(2)-winsize-2,ROI1(3)+winsize+2:ROI1(4)-winsize-2,:),3);
ROIc = ROI1;
...
file1 = file1(1:size(out1,1),1:size(out1,2));


return;%
% for the trip1, day3 vect scan to save
save('/data/bm05/imaging/seb/EU-XFEL/processing/XSVT_oneLens/output1.mat','file1','out1','bigmask')
