...
winsize = 18; % who far to probe and look for the correlation peak

ROI1 = [983 1600 377 1050];% for 1 trip one lens
...
save('/data/bm05/imaging/seb/EU-XFEL/processing/XSVT_collim/output1.mat','file1','out1','bigmask')
