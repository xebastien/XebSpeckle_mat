...
fileName = '/data/bm05/imaging/seb/LCLS/speckle/run243_det0.h5';        % with diamond membrane
fileName = '/data/bm05/imaging/seb/LCLS/speckle/run234_det0.h5';        % with phase plate step 400 nm
%fileName = '/data/bm05/imaging/seb/LCLS/speckle/run18_det0.h5';        % no phase plate
...
for k = 1 :nImages
    stsample(:,:,k) = (single(files1(k).data) - mean(single(files1(k).data(:))))./std(single(files1(k).data(:)));
    stref(:,:,k)    = (single(files2(k).data) - mean(single(files2(k).data(:))))./std(single(files2(k).data(:)));
end;
