function [delay,coeff,pic3] = SliceDelayXdefl(plane1, plane2,edge)
...
%edge = 25 ;%important for the offset
edgeV = 3;%
...
if onlyright,
    plane1t = plane1(edgeV:end-edgeV,1:end-edge);
elseif onlyleft
    plane1t = plane1(edgeV:end-edgeV,edge:end);
else
...
%     % three values)
%     [~,I(1),I(2)] = max2(crosscorr(gaussEdge+1:end-gaussEdge-1,gaussEdge+1:end-gaussEdge-1));
%     I(2) = I(2) + gaussEdge;
%     yd = crosscorr(I(1),I(2)-gaussEdge:I(2)+gaussEdge);
