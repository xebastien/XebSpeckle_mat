...
% xlabel('mm');ylabel('nm')
% yyaxis right
plot(m1,phiW(:,mil(2)).*kw2.*mask1(:,mil(2)),'b','LineWidth',2)%,'LineStyle',':')
hold on
plot(m1,phiWo(:,mil(2)).*kw2.*mask1(:,mil(2)),'black','LineWidth',2)%,'LineStyle','--')
plot(m1,phiD(:,mil(2)).*kw2.*mask1(:,mil(2)),'m','LineWidth',1,'LineStyle','--')
